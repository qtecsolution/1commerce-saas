<template>
                            ...
                            <div class="client_section_2">
                                ...
                                <div class="client_right">
                                    <div class="quote_icon">
                                        <img
                                            :src="`${appUrl}/cycle/images/quote-icon.png`"
                                        />
                                    </div>
                                    <p class="client_text">
                                        {{ testimonial.review }}
    ...
    <div class="copyright_section">
        <div class="container">
            ...
            <p class="copyright_text">
                Disrtributed By. <a href="javascript:void(0)">1commerce </a>
            </p>
        </div>
    </div>
...
export default {
    ...
    mounted() {
        ...
        this.shippingCostInDhaka =
            this.user_template.shipping_cost_inside_dhaka;
        this.shippingCostOutDhaka =
        ...
        this.address =
            footerArea != null && footerArea.address
                ...
                : this.address;
        this.phone =
            footerArea != null && footerArea.phone
                ? footerArea.phone
                : this.phone;
        this.email =
            footerArea != null && footerArea.email
                ? footerArea.email
                : this.email;
        this.mapIframe =
    ...
    methods: {
        ...
        updateTestimonialsItem(testimonials) {
            ...
            testimonials.forEach((item, index) => {
                ...
                formData.append(
                    `items[${index}][reviewer_name]`,
                    item.reviewer_name
                );
                formData.append(
                    `items[${index}][reviewer_bio]`,
                    item.reviewer_bio
                );
            });
            axios
