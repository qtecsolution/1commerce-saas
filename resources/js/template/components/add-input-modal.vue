...
export default {
    ...
    methods: {
        addOption() {
            this.field.options.push(""); // Add a new empty option
        },
        removeOption(index) {
            this.field.options.splice(index, 1); // Remove option at the given index
        },
        saveChanges() {
            this.$emit("save", this.field); // Emit the field data to the parent component
