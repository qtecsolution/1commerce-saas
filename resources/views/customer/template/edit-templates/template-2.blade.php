                ...
                <div class="landing_fifteen_Conpad__ZdT14 container-fluid"><img class="landing_fifteen_img1__HBntM"
                    ...
                    <div class="landing_fifteen_bgimg__E78kd"
                        ...
                        <div class="container">
                            ...
                            {{-- edit and update button for section --}}
                            <div class="edit-section-btn">
                                <button v-if="!edit_section" @click.prevent="editSection('1', true)" class="edit-btn">
                                    Edit
                                </button>
                                <button v-else @click.prevent="updateSection()" class="edit-btn">
                                    Update
                                </button>
                                <button v-if="edit_section" @click.prevent="editSection(false)" class="edit-btn">
                                    Close
                                </button>
                            </div>
                            ...
                            <div class="landing_fifteen_ColReverce__BZNpi row">
                                <div class="landing_fifteen_ColCenterMob__N9EnT col-lg-6 col-md-12">
                                    ...
                                    {{-- section one title --}}
                                    <h1 v-if="!edit_section">
                                        @{{ section_one_header_text }}
                                    </h1>
                                    <h1 v-else v-model="section_one_header_text" contenteditable="true">
                                        @{{ section_one_header_text }}
                                    </h1>

                                    <a class="landing_fifteen_bg__hRDsD" href="#placeAnOrder"><svg stroke="currentColor"
                                        ...
                                        <a class="landing_fifteen_bg2__qKKij" href="#placeAnOrder">১৬৫০ টাকা </a>
...
@section('page_js')
    <script>
        let theme_id = @json($user_theme->theme_id);
        let user_id = @json($user_theme->user_id);
        let product_id = @json($user_theme->product_id);
    </script>
    <script src="{{ asset('assets/js/template/edit_template_2.js') }}"></script>
@endsection
