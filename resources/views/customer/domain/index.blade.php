        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Add Your Custom Domain</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('custom-domain.store') }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                name="domain_name" pattern="^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$" placeholder="Ex: example.com" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            ...
                                            <span class="text-danger"> <i class="fa fa-times"></i> Not Verified </span> 
                                            @else
                                            <span class="text-warning" title="Partially verified"> <i class="fa fa-info-circle"></i> Partial Verified </span> 
                                            @endif
                                        <a href="{{route('custom-domain.edit',$domain->id)}}" title="Try Again" class="ml-2"><i class="fa fa-retweet"></i></a>
                                        @endif
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            data-target="#editModal_{{ $domain->id }}"> <i class="fa fa-pen"></i> </a>

                                        {{-- update modal start --}}
                                        <div class="modal modal-right fade"
                                            id="editModal_{{ $domain->id }}" tabindex="-1"
                                            aria-labelledby="editModalLabel_{{ $domain->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-left">
                                                        <form action="{{ route('custom-domain.update', $domain->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="update_domain_name" class="form-label">Custom Domain<span class="text-danger"><sup>*</sup></span> :</label>
                                                                    <input type="text" id="update_domain_name" value="{{ old('update_domain_name') ?? $domain->domain_name }}" class="form-control"
                                                                    name="update_domain_name" pattern="^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$" placeholder="Ex: example.com" required>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <select id="site" name="user_template_id" class="form-control">
                                                                        @foreach($userTemplates as $site)
                                                                            <option value="{{$site->id}}" @if($site->id == $domain->user_template_id) selected @endif > {{$site->company_name}} ({{$site->company_slug}}) </option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    <p class="text-black font-weight-bold"><b class="text-danger">Note:</b> Before submitting a request for your custom domain, please ensure that you have added the records (Listed in the Add Records table) to your domain registrar account.</p>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                        ...
                                        data-target="#deleteModal_{{ $domain->id }}"> <i class="fa fa-trash"></i> </a>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="delete-info text-center">
                                                                ...
                                                                <p class="delete-text">Are you sure you want to delete it? Data cannot be undone.
                                                                </p>
                                                            </div>
                                                            <div class="row justify-content-around border-top pt-3">
                                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                                                                <form action="{{ route('custom-domain.destroy', $domain->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
