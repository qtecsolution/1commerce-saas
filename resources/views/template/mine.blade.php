                                    ...
                                    <div class="card-data py-3 px-3">
                                        ...
                                        <div class="btn-group">
                                            <a href="{{ route('user_shop', $userTemplate->company_slug) }}"
                                                class="btn btn-success btn-sm" target="_blank" title="Live">
                                                {{-- Live --}}
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="size-6" width="20">
                                            ...
                                            <a href="{{ route('settings', $userTemplate['id']) }}"
                                                class="btn bg-orange btn-sm" title="Settings">
                                                {{-- Settings --}}
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="size-6" width="20">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
