                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" placeholder="title" value="{{ $package->title }}" id="" class="form-control">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="" class="form-label">Price:</label>
                            <input type="number" name="price" placeholder="price" value="{{ $package->price }}" id="" class="form-control">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="" class="form-label">Duration:</label>
                            <input type="number" name="duration" placeholder="duration" value="{{ $package->duration }}" id="" class="form-control">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="" class="form-label">Feature 1:</label>
                            <input type="text" name="feature_0" placeholder="" value="" id="" class="form-control">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
